...
public class Sender {
    ...
    public void sendJuiceRequest(String juiceExe, int numJuice, String intermediatePrefix, String destFile, int isDelete) {
        Message juiceRequest = new JuiceRequest(juiceExe, numJuice, intermediatePrefix, destFile, isDelete);
        this.dataTransfer.send(juiceRequest.toJSON(),MasterInfo.Master_IP_ADDRESS, MasterInfo.MASTER_PORT);
    }
}
